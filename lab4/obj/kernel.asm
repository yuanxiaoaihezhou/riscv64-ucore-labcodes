...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6a3040ef          	jal	ra,ffffffffc0204eec <memset>
...
ffffffffc0200056:	eee58593          	addi	a1,a1,-274 # ffffffffc0204f40 <etext+0x6>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	f0650513          	addi	a0,a0,-250 # ffffffffc0204f60 <etext+0x26>
...
ffffffffc020007a:	658040ef          	jal	ra,ffffffffc02046d2 <proc_init>
...
ffffffffc020008e:	093040ef          	jal	ra,ffffffffc0204920 <cpu_idle>
...
ffffffffc02000ac:	ec050513          	addi	a0,a0,-320 # ffffffffc0204f68 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	17b040ef          	jal	ra,ffffffffc0204aee <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	145040ef          	jal	ra,ffffffffc0204aee <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	da650513          	addi	a0,a0,-602 # ffffffffc0204f70 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc02001e4:	db050513          	addi	a0,a0,-592 # ffffffffc0204f90 <etext+0x56>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d4e58593          	addi	a1,a1,-690 # ffffffffc0204f3a <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	dbc50513          	addi	a0,a0,-580 # ffffffffc0204fb0 <etext+0x76>
...
ffffffffc020020c:	dc850513          	addi	a0,a0,-568 # ffffffffc0204fd0 <etext+0x96>
...
ffffffffc0200220:	dd450513          	addi	a0,a0,-556 # ffffffffc0204ff0 <etext+0xb6>
...
ffffffffc020024e:	dc650513          	addi	a0,a0,-570 # ffffffffc0205010 <etext+0xd6>
}
...
ffffffffc020025c:	de860613          	addi	a2,a2,-536 # ffffffffc0205040 <etext+0x106>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	df450513          	addi	a0,a0,-524 # ffffffffc0205058 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc0200278:	dfc60613          	addi	a2,a2,-516 # ffffffffc0205070 <etext+0x136>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e1458593          	addi	a1,a1,-492 # ffffffffc0205090 <etext+0x156>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e1450513          	addi	a0,a0,-492 # ffffffffc0205098 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e1660613          	addi	a2,a2,-490 # ffffffffc02050a8 <etext+0x16e>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e3658593          	addi	a1,a1,-458 # ffffffffc02050d0 <etext+0x196>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	df650513          	addi	a0,a0,-522 # ffffffffc0205098 <etext+0x15e>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e3260613          	addi	a2,a2,-462 # ffffffffc02050e0 <etext+0x1a6>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e4a58593          	addi	a1,a1,-438 # ffffffffc0205100 <etext+0x1c6>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dda50513          	addi	a0,a0,-550 # ffffffffc0205098 <etext+0x15e>
...
ffffffffc02002fc:	e1850513          	addi	a0,a0,-488 # ffffffffc0205110 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e1e50513          	addi	a0,a0,-482 # ffffffffc0205138 <etext+0x1fe>
...
ffffffffc0200348:	e1c90913          	addi	s2,s2,-484 # ffffffffc0205160 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e1c48493          	addi	s1,s1,-484 # ffffffffc0205168 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e1ab0b13          	addi	s6,s6,-486 # ffffffffc0205170 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d32a0a13          	addi	s4,s4,-718 # ffffffffc0205090 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	32b040ef          	jal	ra,ffffffffc0204eb8 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	317040ef          	jal	ra,ffffffffc0204eb8 <strcmp>
...
ffffffffc02003e0:	2f7040ef          	jal	ra,ffffffffc0204ed6 <strchr>
...
ffffffffc020041e:	2b9040ef          	jal	ra,ffffffffc0204ed6 <strchr>
...
ffffffffc020043c:	d5850513          	addi	a0,a0,-680 # ffffffffc0205190 <etext+0x256>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	173040ef          	jal	ra,ffffffffc0204efe <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	14f040ef          	jal	ra,ffffffffc0204efe <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	43e63603          	ld	a2,1086(a2) # ffffffffc0207068 <nbase>
...
ffffffffc02016f4:	9786b683          	ld	a3,-1672(a3) # ffffffffc0207068 <nbase>
...
ffffffffc0201968:	70453503          	ld	a0,1796(a0) # ffffffffc0207068 <nbase>
...
ffffffffc0201bbe:	32e030ef          	jal	ra,ffffffffc0204eec <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	29c030ef          	jal	ra,ffffffffc0204eec <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	355020ef          	jal	ra,ffffffffc0204ea6 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	35b020ef          	jal	ra,ffffffffc0204eb8 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2dd020ef          	jal	ra,ffffffffc0204e70 <strlen>
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	56a010ef          	jal	ra,ffffffffc02040ea <swapfs_init>
...
ffffffffc0202e2c:	24060613          	addi	a2,a2,576 # ffffffffc0207068 <nbase>
...
ffffffffc020335a:	657000ef          	jal	ra,ffffffffc02041b0 <swapfs_write>
...
ffffffffc02033f8:	52b000ef          	jal	ra,ffffffffc0204122 <swapfs_read>
...
ffffffffc0203cc2:	3aaa3a03          	ld	s4,938(s4) # ffffffffc0207068 <nbase>
...
ffffffffc0204022:	cd45                	beqz	a0,ffffffffc02040da <do_pgfault+0xfc>
...
ffffffffc0204084:	b0050513          	addi	a0,a0,-1280 # ffffffffc0206b80 <default_pmm_manager+0xef0>
...
ffffffffc0204096:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206b30 <default_pmm_manager+0xea0>
...
ffffffffc02040a6:	b4e50513          	addi	a0,a0,-1202 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
...
ffffffffc02040b6:	af650513          	addi	a0,a0,-1290 # ffffffffc0206ba8 <default_pmm_manager+0xf18>
...
ffffffffc02040c6:	b0650513          	addi	a0,a0,-1274 # ffffffffc0206bc8 <default_pmm_manager+0xf38>
...
ffffffffc02040d2:	5971                	li	s2,-4
                free_page(page);
ffffffffc02040d4:	9ebfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
            goto failed;
ffffffffc02040d8:	b761                	j	ffffffffc0204060 <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040da:	00003517          	auipc	a0,0x3
ffffffffc02040de:	a8650513          	addi	a0,a0,-1402 # ffffffffc0206b60 <default_pmm_manager+0xed0>
ffffffffc02040e2:	89efc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040e6:	5971                	li	s2,-4
        goto failed;
ffffffffc02040e8:	bfa5                	j	ffffffffc0204060 <do_pgfault+0x82>
...
ffffffffc02040ee:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040f0:	c78fc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040f4:	cd01                	beqz	a0,ffffffffc020410c <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040f6:	4505                	li	a0,1
ffffffffc02040f8:	c76fc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040fc:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040fe:	810d                	srli	a0,a0,0x3
ffffffffc0204100:	00012797          	auipc	a5,0x12
ffffffffc0204104:	48a7b423          	sd	a0,1160(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc0204108:	0141                	addi	sp,sp,16
ffffffffc020410a:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc020410c:	00003617          	auipc	a2,0x3
ffffffffc0204110:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0206c18 <default_pmm_manager+0xf88>
ffffffffc0204114:	45b5                	li	a1,13
ffffffffc0204116:	00003517          	auipc	a0,0x3
ffffffffc020411a:	b2250513          	addi	a0,a0,-1246 # ffffffffc0206c38 <default_pmm_manager+0xfa8>
ffffffffc020411e:	b28fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204130:	45c73703          	ld	a4,1116(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc0204134:	04e7f563          	bgeu	a5,a4,ffffffffc020417e <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204138:	00012617          	auipc	a2,0x12
ffffffffc020413c:	43863603          	ld	a2,1080(a2) # ffffffffc0216570 <pages>
ffffffffc0204140:	8d91                	sub	a1,a1,a2
ffffffffc0204142:	4065d613          	srai	a2,a1,0x6
ffffffffc0204146:	00003717          	auipc	a4,0x3
ffffffffc020414a:	f2273703          	ld	a4,-222(a4) # ffffffffc0207068 <nbase>
...
ffffffffc020415a:	4126b683          	ld	a3,1042(a3) # ffffffffc0216568 <npage>
...
ffffffffc020416e:	4167b783          	ld	a5,1046(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0204178:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020417a:	bfafc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc020417e:	86aa                	mv	a3,a0
ffffffffc0204180:	00003617          	auipc	a2,0x3
ffffffffc0204184:	ad060613          	addi	a2,a2,-1328 # ffffffffc0206c50 <default_pmm_manager+0xfc0>
ffffffffc0204188:	45d1                	li	a1,20
ffffffffc020418a:	00003517          	auipc	a0,0x3
ffffffffc020418e:	aae50513          	addi	a0,a0,-1362 # ffffffffc0206c38 <default_pmm_manager+0xfa8>
...
ffffffffc02041a0:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc02041a4:	00002517          	auipc	a0,0x2
ffffffffc02041a8:	b4c50513          	addi	a0,a0,-1204 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc02041ac:	a9afc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02041be:	3ce73703          	ld	a4,974(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc02041c2:	04e7f563          	bgeu	a5,a4,ffffffffc020420c <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041c6:	00012617          	auipc	a2,0x12
ffffffffc02041ca:	3aa63603          	ld	a2,938(a2) # ffffffffc0216570 <pages>
ffffffffc02041ce:	8d91                	sub	a1,a1,a2
ffffffffc02041d0:	4065d613          	srai	a2,a1,0x6
ffffffffc02041d4:	00003717          	auipc	a4,0x3
ffffffffc02041d8:	e9473703          	ld	a4,-364(a4) # ffffffffc0207068 <nbase>
...
ffffffffc02041e8:	3846b683          	ld	a3,900(a3) # ffffffffc0216568 <npage>
...
ffffffffc02041fc:	3887b783          	ld	a5,904(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0204206:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204208:	b90fc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc020420c:	86aa                	mv	a3,a0
ffffffffc020420e:	00003617          	auipc	a2,0x3
ffffffffc0204212:	a4260613          	addi	a2,a2,-1470 # ffffffffc0206c50 <default_pmm_manager+0xfc0>
ffffffffc0204216:	45e5                	li	a1,25
ffffffffc0204218:	00003517          	auipc	a0,0x3
ffffffffc020421c:	a2050513          	addi	a0,a0,-1504 # ffffffffc0206c38 <default_pmm_manager+0xfa8>
...
ffffffffc020422e:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0204232:	00002517          	auipc	a0,0x2
ffffffffc0204236:	abe50513          	addi	a0,a0,-1346 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc0204240:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204242:	474000ef          	jal	ra,ffffffffc02046b6 <do_exit>
...
ffffffffc020424e:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204250:	dfefd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020425e:	07000613          	li	a2,112
ffffffffc0204262:	4581                	li	a1,0
        proc->runs = 0;
ffffffffc0204264:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;
ffffffffc0204268:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;
ffffffffc020426c:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;
ffffffffc0204270:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;
ffffffffc0204274:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204278:	03050513          	addi	a0,a0,48
ffffffffc020427c:	471000ef          	jal	ra,ffffffffc0204eec <memset>
...
ffffffffc0204284:	2d87b783          	ld	a5,728(a5) # ffffffffc0216558 <boot_cr3>
        proc->tf = NULL;
...
ffffffffc020429a:	453000ef          	jal	ra,ffffffffc0204eec <memset>
...
ffffffffc02042ac:	3087b783          	ld	a5,776(a5) # ffffffffc02165b0 <current>
ffffffffc02042b0:	73c8                	ld	a0,160(a5)
ffffffffc02042b2:	8bbfc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc02042b6 <init_main>:
    panic("process exit!!.\n");
}
...
static int
init_main(void *arg) {
ffffffffc02042b6:	7179                	addi	sp,sp,-48
ffffffffc02042b8:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042ba:	00012497          	auipc	s1,0x12
ffffffffc02042be:	25e48493          	addi	s1,s1,606 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042c2:	f022                	sd	s0,32(sp)
ffffffffc02042c4:	e84a                	sd	s2,16(sp)
ffffffffc02042c6:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c8:	00012917          	auipc	s2,0x12
ffffffffc02042cc:	2e893903          	ld	s2,744(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042d8:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042da:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042de:	40f000ef          	jal	ra,ffffffffc0204eec <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042e2:	0b490593          	addi	a1,s2,180
ffffffffc02042e6:	463d                	li	a2,15
ffffffffc02042e8:	8526                	mv	a0,s1
ffffffffc02042ea:	415000ef          	jal	ra,ffffffffc0204efe <memcpy>
ffffffffc02042ee:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042f0:	85ce                	mv	a1,s3
ffffffffc02042f2:	00003517          	auipc	a0,0x3
ffffffffc02042f6:	97e50513          	addi	a0,a0,-1666 # ffffffffc0206c70 <default_pmm_manager+0xfe0>
...
ffffffffc0204304:	99850513          	addi	a0,a0,-1640 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204308:	e79fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc020430c:	00003517          	auipc	a0,0x3
ffffffffc0204310:	99c50513          	addi	a0,a0,-1636 # ffffffffc0206ca8 <default_pmm_manager+0x1018>
ffffffffc0204314:	e6dfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0204318:	70a2                	ld	ra,40(sp)
ffffffffc020431a:	7402                	ld	s0,32(sp)
ffffffffc020431c:	64e2                	ld	s1,24(sp)
ffffffffc020431e:	6942                	ld	s2,16(sp)
ffffffffc0204320:	69a2                	ld	s3,8(sp)
ffffffffc0204322:	4501                	li	a0,0
ffffffffc0204324:	6145                	addi	sp,sp,48
ffffffffc0204326:	8082                	ret

ffffffffc0204328 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204328:	7179                	addi	sp,sp,-48
ffffffffc020432a:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc020432c:	00012917          	auipc	s2,0x12
ffffffffc0204330:	28490913          	addi	s2,s2,644 # ffffffffc02165b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204334:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204336:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc020433a:	f406                	sd	ra,40(sp)
ffffffffc020433c:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc020433e:	02a48963          	beq	s1,a0,ffffffffc0204370 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204342:	100027f3          	csrr	a5,sstatus
ffffffffc0204346:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204348:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020434a:	e3a1                	bnez	a5,ffffffffc020438a <proc_run+0x62>
            lcr3(proc->cr3);
...
ffffffffc020434e:	80000737          	lui	a4,0x80000
            current=proc;
ffffffffc0204352:	00a93023          	sd	a0,0(s2)
ffffffffc0204356:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020435a:	8fd9                	or	a5,a5,a4
ffffffffc020435c:	18079073          	csrw	satp,a5
            switch_to(&(pre->context),&(proc->context));
ffffffffc0204360:	03050593          	addi	a1,a0,48
ffffffffc0204364:	03048513          	addi	a0,s1,48
ffffffffc0204368:	5d4000ef          	jal	ra,ffffffffc020493c <switch_to>
    if (flag) {
ffffffffc020436c:	00099863          	bnez	s3,ffffffffc020437c <proc_run+0x54>
}
ffffffffc0204370:	70a2                	ld	ra,40(sp)
ffffffffc0204372:	7482                	ld	s1,32(sp)
ffffffffc0204374:	6962                	ld	s2,24(sp)
ffffffffc0204376:	69c2                	ld	s3,16(sp)
ffffffffc0204378:	6145                	addi	sp,sp,48
ffffffffc020437a:	8082                	ret
ffffffffc020437c:	70a2                	ld	ra,40(sp)
ffffffffc020437e:	7482                	ld	s1,32(sp)
ffffffffc0204380:	6962                	ld	s2,24(sp)
ffffffffc0204382:	69c2                	ld	s3,16(sp)
ffffffffc0204384:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204386:	a36fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc020438a:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020438c:	a36fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204390:	6522                	ld	a0,8(sp)
ffffffffc0204392:	4985                	li	s3,1
ffffffffc0204394:	bf65                	j	ffffffffc020434c <proc_run+0x24>

ffffffffc0204396 <do_fork>:
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204396:	00012717          	auipc	a4,0x12
ffffffffc020439a:	23272703          	lw	a4,562(a4) # ffffffffc02165c8 <nr_process>
ffffffffc020439e:	6785                	lui	a5,0x1
ffffffffc02043a0:	24f75863          	bge	a4,a5,ffffffffc02045f0 <do_fork+0x25a>
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc02043a4:	1101                	addi	sp,sp,-32
ffffffffc02043a6:	e822                	sd	s0,16(sp)
ffffffffc02043a8:	e426                	sd	s1,8(sp)
ffffffffc02043aa:	e04a                	sd	s2,0(sp)
ffffffffc02043ac:	ec06                	sd	ra,24(sp)
ffffffffc02043ae:	84ae                	mv	s1,a1
ffffffffc02043b0:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc02043b2:	e95ff0ef          	jal	ra,ffffffffc0204246 <alloc_proc>
ffffffffc02043b6:	892a                	mv	s2,a0
    if (proc == NULL) {
ffffffffc02043b8:	24050163          	beqz	a0,ffffffffc02045fa <do_fork+0x264>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043bc:	4509                	li	a0,2
ffffffffc02043be:	e6efd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043c2:	1e050163          	beqz	a0,ffffffffc02045a4 <do_fork+0x20e>
    return page - pages + nbase;
ffffffffc02043c6:	00012697          	auipc	a3,0x12
ffffffffc02043ca:	1aa6b683          	ld	a3,426(a3) # ffffffffc0216570 <pages>
ffffffffc02043ce:	40d506b3          	sub	a3,a0,a3
ffffffffc02043d2:	8699                	srai	a3,a3,0x6
ffffffffc02043d4:	00003517          	auipc	a0,0x3
ffffffffc02043d8:	c9453503          	ld	a0,-876(a0) # ffffffffc0207068 <nbase>
ffffffffc02043dc:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043de:	00c69793          	slli	a5,a3,0xc
ffffffffc02043e2:	83b1                	srli	a5,a5,0xc
ffffffffc02043e4:	00012717          	auipc	a4,0x12
ffffffffc02043e8:	18473703          	ld	a4,388(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043ec:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043ee:	22e7f863          	bgeu	a5,a4,ffffffffc020461e <do_fork+0x288>
    assert(current->mm == NULL);
ffffffffc02043f2:	00012797          	auipc	a5,0x12
ffffffffc02043f6:	1be7b783          	ld	a5,446(a5) # ffffffffc02165b0 <current>
...
ffffffffc0204406:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc020440a:	1e079a63          	bnez	a5,ffffffffc02045fe <do_fork+0x268>
...
ffffffffc0204416:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204418:	0ad93023          	sd	a3,160(s2)
    *(proc->tf) = *tf;
...
ffffffffc020443e:	ff1612e3          	bne	a2,a7,ffffffffc0204422 <do_fork+0x8c>
    proc->tf->gpr.a0 = 0;
ffffffffc0204442:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204446:	10048e63          	beqz	s1,ffffffffc0204562 <do_fork+0x1cc>
ffffffffc020444a:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020444c:	00000797          	auipc	a5,0x0
ffffffffc0204450:	e5c78793          	addi	a5,a5,-420 # ffffffffc02042a8 <forkret>
ffffffffc0204454:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204458:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020445c:	100027f3          	csrr	a5,sstatus
ffffffffc0204460:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204462:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204464:	10079f63          	bnez	a5,ffffffffc0204582 <do_fork+0x1ec>
    if (++ last_pid >= MAX_PID) {
...
ffffffffc020447e:	06e55b63          	bge	a0,a4,ffffffffc02044f4 <do_fork+0x15e>
...
ffffffffc0204496:	06f55763          	bge	a0,a5,ffffffffc0204504 <do_fork+0x16e>
        proc->pid=get_pid();
ffffffffc020449a:	00a92223          	sw	a0,4(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020449e:	45a9                	li	a1,10
ffffffffc02044a0:	2501                	sext.w	a0,a0
ffffffffc02044a2:	5ca000ef          	jal	ra,ffffffffc0204a6c <hash32>
...
ffffffffc02044b6:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044b8:	6514                	ld	a3,8(a0)
ffffffffc02044ba:	0d890793          	addi	a5,s2,216
ffffffffc02044be:	6418                	ld	a4,8(s0)
    prev->next = next->prev = elm;
ffffffffc02044c0:	e29c                	sd	a5,0(a3)
ffffffffc02044c2:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044c4:	0ed93023          	sd	a3,224(s2)
        list_add(&proc_list,&(proc->list_link));
ffffffffc02044c8:	0c890793          	addi	a5,s2,200
    elm->prev = prev;
ffffffffc02044cc:	0ca93c23          	sd	a0,216(s2)
    prev->next = next->prev = elm;
ffffffffc02044d0:	e31c                	sd	a5,0(a4)
ffffffffc02044d2:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044d4:	0ce93823          	sd	a4,208(s2)
    elm->prev = prev;
ffffffffc02044d8:	0c893423          	sd	s0,200(s2)
    if (flag) {
ffffffffc02044dc:	e4dd                	bnez	s1,ffffffffc020458a <do_fork+0x1f4>
    wakeup_proc(proc);
ffffffffc02044de:	854a                	mv	a0,s2
ffffffffc02044e0:	4c6000ef          	jal	ra,ffffffffc02049a6 <wakeup_proc>
    ret=proc->pid;
ffffffffc02044e4:	00492503          	lw	a0,4(s2)
}
ffffffffc02044e8:	60e2                	ld	ra,24(sp)
ffffffffc02044ea:	6442                	ld	s0,16(sp)
ffffffffc02044ec:	64a2                	ld	s1,8(sp)
ffffffffc02044ee:	6902                	ld	s2,0(sp)
ffffffffc02044f0:	6105                	addi	sp,sp,32
ffffffffc02044f2:	8082                	ret
        last_pid = 1;
ffffffffc02044f4:	4785                	li	a5,1
ffffffffc02044f6:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044fa:	4505                	li	a0,1
ffffffffc02044fc:	00007317          	auipc	t1,0x7
ffffffffc0204500:	b6030313          	addi	t1,t1,-1184 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204504:	00012417          	auipc	s0,0x12
ffffffffc0204508:	02440413          	addi	s0,s0,36 # ffffffffc0216528 <proc_list>
ffffffffc020450c:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204510:	6789                	lui	a5,0x2
ffffffffc0204512:	00f32023          	sw	a5,0(t1)
ffffffffc0204516:	86aa                	mv	a3,a0
ffffffffc0204518:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc020451a:	6e89                	lui	t4,0x2
ffffffffc020451c:	068e0f63          	beq	t3,s0,ffffffffc020459a <do_fork+0x204>
ffffffffc0204520:	88ae                	mv	a7,a1
ffffffffc0204522:	87f2                	mv	a5,t3
ffffffffc0204524:	6609                	lui	a2,0x2
ffffffffc0204526:	a811                	j	ffffffffc020453a <do_fork+0x1a4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204528:	00e6d663          	bge	a3,a4,ffffffffc0204534 <do_fork+0x19e>
ffffffffc020452c:	00c75463          	bge	a4,a2,ffffffffc0204534 <do_fork+0x19e>
ffffffffc0204530:	863a                	mv	a2,a4
ffffffffc0204532:	4885                	li	a7,1
ffffffffc0204534:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204536:	00878d63          	beq	a5,s0,ffffffffc0204550 <do_fork+0x1ba>
            if (proc->pid == last_pid) {
ffffffffc020453a:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020453e:	fed715e3          	bne	a4,a3,ffffffffc0204528 <do_fork+0x192>
                if (++ last_pid >= next_safe) {
ffffffffc0204542:	2685                	addiw	a3,a3,1
ffffffffc0204544:	04c6d663          	bge	a3,a2,ffffffffc0204590 <do_fork+0x1fa>
ffffffffc0204548:	679c                	ld	a5,8(a5)
ffffffffc020454a:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020454c:	fe8797e3          	bne	a5,s0,ffffffffc020453a <do_fork+0x1a4>
ffffffffc0204550:	c581                	beqz	a1,ffffffffc0204558 <do_fork+0x1c2>
ffffffffc0204552:	00d82023          	sw	a3,0(a6)
ffffffffc0204556:	8536                	mv	a0,a3
ffffffffc0204558:	f40881e3          	beqz	a7,ffffffffc020449a <do_fork+0x104>
ffffffffc020455c:	00c32023          	sw	a2,0(t1)
ffffffffc0204560:	bf2d                	j	ffffffffc020449a <do_fork+0x104>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204562:	84b6                	mv	s1,a3
ffffffffc0204564:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204566:	00000797          	auipc	a5,0x0
ffffffffc020456a:	d4278793          	addi	a5,a5,-702 # ffffffffc02042a8 <forkret>
ffffffffc020456e:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204572:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204576:	100027f3          	csrr	a5,sstatus
ffffffffc020457a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020457c:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020457e:	ee0785e3          	beqz	a5,ffffffffc0204468 <do_fork+0xd2>
        intr_disable();
ffffffffc0204582:	840fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204586:	4485                	li	s1,1
ffffffffc0204588:	b5c5                	j	ffffffffc0204468 <do_fork+0xd2>
        intr_enable();
ffffffffc020458a:	832fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020458e:	bf81                	j	ffffffffc02044de <do_fork+0x148>
                    if (last_pid >= MAX_PID) {
ffffffffc0204590:	01d6c363          	blt	a3,t4,ffffffffc0204596 <do_fork+0x200>
                        last_pid = 1;
ffffffffc0204594:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204596:	4585                	li	a1,1
ffffffffc0204598:	b751                	j	ffffffffc020451c <do_fork+0x186>
ffffffffc020459a:	cda9                	beqz	a1,ffffffffc02045f4 <do_fork+0x25e>
ffffffffc020459c:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045a0:	8536                	mv	a0,a3
ffffffffc02045a2:	bde5                	j	ffffffffc020449a <do_fork+0x104>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045a4:	01093683          	ld	a3,16(s2)
    return pa2page(PADDR(kva));
ffffffffc02045a8:	c02007b7          	lui	a5,0xc0200
ffffffffc02045ac:	0af6e163          	bltu	a3,a5,ffffffffc020464e <do_fork+0x2b8>
ffffffffc02045b0:	00012797          	auipc	a5,0x12
ffffffffc02045b4:	fd07b783          	ld	a5,-48(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045b8:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045bc:	83b1                	srli	a5,a5,0xc
ffffffffc02045be:	00012717          	auipc	a4,0x12
ffffffffc02045c2:	faa73703          	ld	a4,-86(a4) # ffffffffc0216568 <npage>
ffffffffc02045c6:	06e7f863          	bgeu	a5,a4,ffffffffc0204636 <do_fork+0x2a0>
    return &pages[PPN(pa) - nbase];
ffffffffc02045ca:	00003717          	auipc	a4,0x3
ffffffffc02045ce:	a9e73703          	ld	a4,-1378(a4) # ffffffffc0207068 <nbase>
ffffffffc02045d2:	8f99                	sub	a5,a5,a4
ffffffffc02045d4:	079a                	slli	a5,a5,0x6
ffffffffc02045d6:	00012517          	auipc	a0,0x12
ffffffffc02045da:	f9a53503          	ld	a0,-102(a0) # ffffffffc0216570 <pages>
ffffffffc02045de:	953e                	add	a0,a0,a5
ffffffffc02045e0:	4589                	li	a1,2
ffffffffc02045e2:	cdcfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045e6:	854a                	mv	a0,s2
ffffffffc02045e8:	b16fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045ec:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045ee:	bded                	j	ffffffffc02044e8 <do_fork+0x152>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045f0:	556d                	li	a0,-5
}
ffffffffc02045f2:	8082                	ret
    return last_pid;
ffffffffc02045f4:	00082503          	lw	a0,0(a6)
ffffffffc02045f8:	b54d                	j	ffffffffc020449a <do_fork+0x104>
    ret = -E_NO_MEM;
ffffffffc02045fa:	5571                	li	a0,-4
    return ret;
ffffffffc02045fc:	b5f5                	j	ffffffffc02044e8 <do_fork+0x152>
    assert(current->mm == NULL);
ffffffffc02045fe:	00002697          	auipc	a3,0x2
ffffffffc0204602:	6ca68693          	addi	a3,a3,1738 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc0204606:	00001617          	auipc	a2,0x1
ffffffffc020460a:	2da60613          	addi	a2,a2,730 # ffffffffc02058e0 <commands+0x738>
ffffffffc020460e:	12900593          	li	a1,297
ffffffffc0204612:	00002517          	auipc	a0,0x2
ffffffffc0204616:	6ce50513          	addi	a0,a0,1742 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc020461a:	e2dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020461e:	00001617          	auipc	a2,0x1
ffffffffc0204622:	6aa60613          	addi	a2,a2,1706 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0204626:	06900593          	li	a1,105
ffffffffc020462a:	00001517          	auipc	a0,0x1
ffffffffc020462e:	6c650513          	addi	a0,a0,1734 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204632:	e15fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204636:	00001617          	auipc	a2,0x1
ffffffffc020463a:	76260613          	addi	a2,a2,1890 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc020463e:	06200593          	li	a1,98
ffffffffc0204642:	00001517          	auipc	a0,0x1
ffffffffc0204646:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc020464a:	dfdfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020464e:	00001617          	auipc	a2,0x1
ffffffffc0204652:	72260613          	addi	a2,a2,1826 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc0204656:	06e00593          	li	a1,110
ffffffffc020465a:	00001517          	auipc	a0,0x1
ffffffffc020465e:	69650513          	addi	a0,a0,1686 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204662:	de5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020467c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020467e:	06f000ef          	jal	ra,ffffffffc0204eec <memset>
...
ffffffffc020469e:	ba478793          	addi	a5,a5,-1116 # ffffffffc020423e <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046a2:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046a4:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046a6:	cf1ff0ef          	jal	ra,ffffffffc0204396 <do_fork>
}
...
ffffffffc02046bc:	64060613          	addi	a2,a2,1600 # ffffffffc0206cf8 <default_pmm_manager+0x1068>
ffffffffc02046c0:	19b00593          	li	a1,411
ffffffffc02046c4:	00002517          	auipc	a0,0x2
ffffffffc02046c8:	61c50513          	addi	a0,a0,1564 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
do_exit(int error_code) {
ffffffffc02046cc:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046ce:	d79fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
void
proc_init(void) {
ffffffffc02046d2:	7179                	addi	sp,sp,-48
ffffffffc02046d4:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046d6:	00012797          	auipc	a5,0x12
ffffffffc02046da:	e5278793          	addi	a5,a5,-430 # ffffffffc0216528 <proc_list>
ffffffffc02046de:	f406                	sd	ra,40(sp)
ffffffffc02046e0:	f022                	sd	s0,32(sp)
ffffffffc02046e2:	e84a                	sd	s2,16(sp)
ffffffffc02046e4:	e44e                	sd	s3,8(sp)
ffffffffc02046e6:	0000e497          	auipc	s1,0xe
ffffffffc02046ea:	e3248493          	addi	s1,s1,-462 # ffffffffc0212518 <hash_list>
...
ffffffffc02046f6:	e2670713          	addi	a4,a4,-474 # ffffffffc0216518 <name.2>
ffffffffc02046fa:	87a6                	mv	a5,s1
ffffffffc02046fc:	e79c                	sd	a5,8(a5)
ffffffffc02046fe:	e39c                	sd	a5,0(a5)
ffffffffc0204700:	07c1                	addi	a5,a5,16
ffffffffc0204702:	fef71de3          	bne	a4,a5,ffffffffc02046fc <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204706:	b41ff0ef          	jal	ra,ffffffffc0204246 <alloc_proc>
ffffffffc020470a:	00012917          	auipc	s2,0x12
ffffffffc020470e:	eae90913          	addi	s2,s2,-338 # ffffffffc02165b8 <idleproc>
ffffffffc0204712:	00a93023          	sd	a0,0(s2)
ffffffffc0204716:	18050d63          	beqz	a0,ffffffffc02048b0 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020471a:	07000513          	li	a0,112
ffffffffc020471e:	930fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc0204728:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020472a:	7c2000ef          	jal	ra,ffffffffc0204eec <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc020472e:	00093503          	ld	a0,0(s2)
ffffffffc0204732:	85a2                	mv	a1,s0
ffffffffc0204734:	07000613          	li	a2,112
ffffffffc0204738:	03050513          	addi	a0,a0,48
ffffffffc020473c:	7da000ef          	jal	ra,ffffffffc0204f16 <memcmp>
ffffffffc0204740:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204742:	453d                	li	a0,15
ffffffffc0204744:	90afd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020474c:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020474e:	79e000ef          	jal	ra,ffffffffc0204eec <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204752:	00093503          	ld	a0,0(s2)
ffffffffc0204756:	463d                	li	a2,15
ffffffffc0204758:	85a2                	mv	a1,s0
ffffffffc020475a:	0b450513          	addi	a0,a0,180
ffffffffc020475e:	7b8000ef          	jal	ra,ffffffffc0204f16 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204762:	00093783          	ld	a5,0(s2)
ffffffffc0204766:	00012717          	auipc	a4,0x12
ffffffffc020476a:	df273703          	ld	a4,-526(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc020476e:	77d4                	ld	a3,168(a5)
ffffffffc0204770:	0ee68463          	beq	a3,a4,ffffffffc0204858 <proc_init+0x186>
...
ffffffffc0204774:	4709                	li	a4,2
ffffffffc0204776:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204778:	00004717          	auipc	a4,0x4
ffffffffc020477c:	88870713          	addi	a4,a4,-1912 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204780:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204784:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0204786:	4705                	li	a4,1
ffffffffc0204788:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020478a:	4641                	li	a2,16
ffffffffc020478c:	4581                	li	a1,0
ffffffffc020478e:	8522                	mv	a0,s0
ffffffffc0204790:	75c000ef          	jal	ra,ffffffffc0204eec <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204794:	463d                	li	a2,15
ffffffffc0204796:	00002597          	auipc	a1,0x2
ffffffffc020479a:	5aa58593          	addi	a1,a1,1450 # ffffffffc0206d40 <default_pmm_manager+0x10b0>
ffffffffc020479e:	8522                	mv	a0,s0
ffffffffc02047a0:	75e000ef          	jal	ra,ffffffffc0204efe <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02047a4:	00012717          	auipc	a4,0x12
ffffffffc02047a8:	e2470713          	addi	a4,a4,-476 # ffffffffc02165c8 <nr_process>
ffffffffc02047ac:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02047ae:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047b2:	4601                	li	a2,0
    nr_process ++;
ffffffffc02047b4:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047b6:	00002597          	auipc	a1,0x2
ffffffffc02047ba:	59258593          	addi	a1,a1,1426 # ffffffffc0206d48 <default_pmm_manager+0x10b8>
ffffffffc02047be:	00000517          	auipc	a0,0x0
ffffffffc02047c2:	af850513          	addi	a0,a0,-1288 # ffffffffc02042b6 <init_main>
    nr_process ++;
ffffffffc02047c6:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047c8:	00012797          	auipc	a5,0x12
ffffffffc02047cc:	ded7b423          	sd	a3,-536(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047d0:	e97ff0ef          	jal	ra,ffffffffc0204666 <kernel_thread>
ffffffffc02047d4:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047d6:	0ea05963          	blez	a0,ffffffffc02048c8 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047da:	6789                	lui	a5,0x2
ffffffffc02047dc:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047e0:	17f9                	addi	a5,a5,-2
ffffffffc02047e2:	2501                	sext.w	a0,a0
ffffffffc02047e4:	02e7e363          	bltu	a5,a4,ffffffffc020480a <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047e8:	45a9                	li	a1,10
ffffffffc02047ea:	282000ef          	jal	ra,ffffffffc0204a6c <hash32>
ffffffffc02047ee:	02051793          	slli	a5,a0,0x20
ffffffffc02047f2:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047f6:	96a6                	add	a3,a3,s1
ffffffffc02047f8:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047fa:	a029                	j	ffffffffc0204804 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc02047fc:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204800:	0a870563          	beq	a4,s0,ffffffffc02048aa <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204804:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204806:	fef69be3          	bne	a3,a5,ffffffffc02047fc <proc_init+0x12a>
    return NULL;
ffffffffc020480a:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020480c:	0b478493          	addi	s1,a5,180
ffffffffc0204810:	4641                	li	a2,16
ffffffffc0204812:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204814:	00012417          	auipc	s0,0x12
ffffffffc0204818:	dac40413          	addi	s0,s0,-596 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020481c:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020481e:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204820:	6cc000ef          	jal	ra,ffffffffc0204eec <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204824:	463d                	li	a2,15
ffffffffc0204826:	00002597          	auipc	a1,0x2
ffffffffc020482a:	55258593          	addi	a1,a1,1362 # ffffffffc0206d78 <default_pmm_manager+0x10e8>
ffffffffc020482e:	8526                	mv	a0,s1
ffffffffc0204830:	6ce000ef          	jal	ra,ffffffffc0204efe <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204834:	00093783          	ld	a5,0(s2)
ffffffffc0204838:	c7e1                	beqz	a5,ffffffffc0204900 <proc_init+0x22e>
ffffffffc020483a:	43dc                	lw	a5,4(a5)
ffffffffc020483c:	e3f1                	bnez	a5,ffffffffc0204900 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020483e:	601c                	ld	a5,0(s0)
ffffffffc0204840:	c3c5                	beqz	a5,ffffffffc02048e0 <proc_init+0x20e>
ffffffffc0204842:	43d8                	lw	a4,4(a5)
ffffffffc0204844:	4785                	li	a5,1
ffffffffc0204846:	08f71d63          	bne	a4,a5,ffffffffc02048e0 <proc_init+0x20e>
}
ffffffffc020484a:	70a2                	ld	ra,40(sp)
ffffffffc020484c:	7402                	ld	s0,32(sp)
ffffffffc020484e:	64e2                	ld	s1,24(sp)
ffffffffc0204850:	6942                	ld	s2,16(sp)
ffffffffc0204852:	69a2                	ld	s3,8(sp)
ffffffffc0204854:	6145                	addi	sp,sp,48
ffffffffc0204856:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204858:	73d8                	ld	a4,160(a5)
ffffffffc020485a:	ff09                	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
ffffffffc020485c:	f0099ce3          	bnez	s3,ffffffffc0204774 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204860:	6394                	ld	a3,0(a5)
ffffffffc0204862:	577d                	li	a4,-1
ffffffffc0204864:	1702                	slli	a4,a4,0x20
ffffffffc0204866:	f0e697e3          	bne	a3,a4,ffffffffc0204774 <proc_init+0xa2>
ffffffffc020486a:	4798                	lw	a4,8(a5)
ffffffffc020486c:	f00714e3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204870:	6b98                	ld	a4,16(a5)
ffffffffc0204872:	f00711e3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
ffffffffc0204876:	4f98                	lw	a4,24(a5)
ffffffffc0204878:	2701                	sext.w	a4,a4
ffffffffc020487a:	ee071de3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
ffffffffc020487e:	7398                	ld	a4,32(a5)
ffffffffc0204880:	ee071ae3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204884:	7798                	ld	a4,40(a5)
ffffffffc0204886:	ee0717e3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
ffffffffc020488a:	0b07a703          	lw	a4,176(a5)
ffffffffc020488e:	8d59                	or	a0,a0,a4
ffffffffc0204890:	0005071b          	sext.w	a4,a0
ffffffffc0204894:	ee0710e3          	bnez	a4,ffffffffc0204774 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0204898:	00002517          	auipc	a0,0x2
ffffffffc020489c:	49050513          	addi	a0,a0,1168 # ffffffffc0206d28 <default_pmm_manager+0x1098>
ffffffffc02048a0:	8e1fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02048a4:	00093783          	ld	a5,0(s2)
ffffffffc02048a8:	b5f1                	j	ffffffffc0204774 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02048aa:	f2878793          	addi	a5,a5,-216
ffffffffc02048ae:	bfb9                	j	ffffffffc020480c <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02048b0:	00002617          	auipc	a2,0x2
ffffffffc02048b4:	46060613          	addi	a2,a2,1120 # ffffffffc0206d10 <default_pmm_manager+0x1080>
ffffffffc02048b8:	1b300593          	li	a1,435
ffffffffc02048bc:	00002517          	auipc	a0,0x2
ffffffffc02048c0:	42450513          	addi	a0,a0,1060 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc02048c4:	b83fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048c8:	00002617          	auipc	a2,0x2
ffffffffc02048cc:	49060613          	addi	a2,a2,1168 # ffffffffc0206d58 <default_pmm_manager+0x10c8>
ffffffffc02048d0:	1d300593          	li	a1,467
ffffffffc02048d4:	00002517          	auipc	a0,0x2
ffffffffc02048d8:	40c50513          	addi	a0,a0,1036 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc02048dc:	b6bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048e0:	00002697          	auipc	a3,0x2
ffffffffc02048e4:	4c868693          	addi	a3,a3,1224 # ffffffffc0206da8 <default_pmm_manager+0x1118>
ffffffffc02048e8:	00001617          	auipc	a2,0x1
ffffffffc02048ec:	ff860613          	addi	a2,a2,-8 # ffffffffc02058e0 <commands+0x738>
ffffffffc02048f0:	1da00593          	li	a1,474
ffffffffc02048f4:	00002517          	auipc	a0,0x2
ffffffffc02048f8:	3ec50513          	addi	a0,a0,1004 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc02048fc:	b4bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204900:	00002697          	auipc	a3,0x2
ffffffffc0204904:	48068693          	addi	a3,a3,1152 # ffffffffc0206d80 <default_pmm_manager+0x10f0>
ffffffffc0204908:	00001617          	auipc	a2,0x1
ffffffffc020490c:	fd860613          	addi	a2,a2,-40 # ffffffffc02058e0 <commands+0x738>
ffffffffc0204910:	1d900593          	li	a1,473
ffffffffc0204914:	00002517          	auipc	a0,0x2
ffffffffc0204918:	3cc50513          	addi	a0,a0,972 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc020491c:	b2bfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204920 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204920:	1141                	addi	sp,sp,-16
ffffffffc0204922:	e022                	sd	s0,0(sp)
ffffffffc0204924:	e406                	sd	ra,8(sp)
ffffffffc0204926:	00012417          	auipc	s0,0x12
ffffffffc020492a:	c8a40413          	addi	s0,s0,-886 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020492e:	6018                	ld	a4,0(s0)
ffffffffc0204930:	4f1c                	lw	a5,24(a4)
ffffffffc0204932:	2781                	sext.w	a5,a5
ffffffffc0204934:	dff5                	beqz	a5,ffffffffc0204930 <cpu_idle+0x10>
            schedule();
ffffffffc0204936:	0a2000ef          	jal	ra,ffffffffc02049d8 <schedule>
ffffffffc020493a:	bfd5                	j	ffffffffc020492e <cpu_idle+0xe>

ffffffffc020493c <switch_to>:
.text
...
ffffffffc020493c:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204940:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204944:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204946:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204948:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020494c:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204950:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204954:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204958:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020495c:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204960:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204964:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204968:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020496c:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204970:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204974:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204978:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020497a:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020497c:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204980:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204984:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204988:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020498c:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204990:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204994:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204998:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020499c:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049a0:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02049a4:	8082                	ret

ffffffffc02049a6 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02049a6:	411c                	lw	a5,0(a0)
ffffffffc02049a8:	4705                	li	a4,1
ffffffffc02049aa:	37f9                	addiw	a5,a5,-2
ffffffffc02049ac:	00f77563          	bgeu	a4,a5,ffffffffc02049b6 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02049b0:	4789                	li	a5,2
ffffffffc02049b2:	c11c                	sw	a5,0(a0)
ffffffffc02049b4:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049b6:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049b8:	00002697          	auipc	a3,0x2
ffffffffc02049bc:	41868693          	addi	a3,a3,1048 # ffffffffc0206dd0 <default_pmm_manager+0x1140>
ffffffffc02049c0:	00001617          	auipc	a2,0x1
ffffffffc02049c4:	f2060613          	addi	a2,a2,-224 # ffffffffc02058e0 <commands+0x738>
ffffffffc02049c8:	45a5                	li	a1,9
ffffffffc02049ca:	00002517          	auipc	a0,0x2
ffffffffc02049ce:	44650513          	addi	a0,a0,1094 # ffffffffc0206e10 <default_pmm_manager+0x1180>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049d2:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049d4:	a73fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049d8 <schedule>:
}

void
schedule(void) {
ffffffffc02049d8:	1141                	addi	sp,sp,-16
ffffffffc02049da:	e406                	sd	ra,8(sp)
ffffffffc02049dc:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049de:	100027f3          	csrr	a5,sstatus
ffffffffc02049e2:	8b89                	andi	a5,a5,2
ffffffffc02049e4:	4401                	li	s0,0
ffffffffc02049e6:	efbd                	bnez	a5,ffffffffc0204a64 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049e8:	00012897          	auipc	a7,0x12
ffffffffc02049ec:	bc88b883          	ld	a7,-1080(a7) # ffffffffc02165b0 <current>
ffffffffc02049f0:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049f4:	00012517          	auipc	a0,0x12
ffffffffc02049f8:	bc453503          	ld	a0,-1084(a0) # ffffffffc02165b8 <idleproc>
ffffffffc02049fc:	04a88e63          	beq	a7,a0,ffffffffc0204a58 <schedule+0x80>
ffffffffc0204a00:	0c888693          	addi	a3,a7,200
ffffffffc0204a04:	00012617          	auipc	a2,0x12
ffffffffc0204a08:	b2460613          	addi	a2,a2,-1244 # ffffffffc0216528 <proc_list>
        le = last;
...
ffffffffc0204a12:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a14:	00c78863          	beq	a5,a2,ffffffffc0204a24 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a18:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a1c:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a20:	03070163          	beq	a4,a6,ffffffffc0204a42 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a24:	fef697e3          	bne	a3,a5,ffffffffc0204a12 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a28:	ed89                	bnez	a1,ffffffffc0204a42 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a2a:	451c                	lw	a5,8(a0)
ffffffffc0204a2c:	2785                	addiw	a5,a5,1
ffffffffc0204a2e:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a30:	00a88463          	beq	a7,a0,ffffffffc0204a38 <schedule+0x60>
            proc_run(next);
ffffffffc0204a34:	8f5ff0ef          	jal	ra,ffffffffc0204328 <proc_run>
    if (flag) {
ffffffffc0204a38:	e819                	bnez	s0,ffffffffc0204a4e <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204a3e:	0141                	addi	sp,sp,16
ffffffffc0204a40:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a42:	4198                	lw	a4,0(a1)
ffffffffc0204a44:	4789                	li	a5,2
ffffffffc0204a46:	fef712e3          	bne	a4,a5,ffffffffc0204a2a <schedule+0x52>
ffffffffc0204a4a:	852e                	mv	a0,a1
ffffffffc0204a4c:	bff9                	j	ffffffffc0204a2a <schedule+0x52>
}
ffffffffc0204a4e:	6402                	ld	s0,0(sp)
ffffffffc0204a50:	60a2                	ld	ra,8(sp)
ffffffffc0204a52:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a54:	b69fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a58:	00012617          	auipc	a2,0x12
ffffffffc0204a5c:	ad060613          	addi	a2,a2,-1328 # ffffffffc0216528 <proc_list>
ffffffffc0204a60:	86b2                	mv	a3,a2
ffffffffc0204a62:	b76d                	j	ffffffffc0204a0c <schedule+0x34>
        intr_disable();
ffffffffc0204a64:	b5ffb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a68:	4405                	li	s0,1
ffffffffc0204a6a:	bfbd                	j	ffffffffc02049e8 <schedule+0x10>
...
ffffffffc0204a72:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a76:	02000793          	li	a5,32
ffffffffc0204a7a:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a7c:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a80:	8082                	ret

ffffffffc0204a82 <printnum>:
 * */
static void
...
ffffffffc0204a82:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a86:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a88:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a8c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a8e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a92:	f022                	sd	s0,32(sp)
ffffffffc0204a94:	ec26                	sd	s1,24(sp)
ffffffffc0204a96:	e84a                	sd	s2,16(sp)
ffffffffc0204a98:	f406                	sd	ra,40(sp)
ffffffffc0204a9a:	e44e                	sd	s3,8(sp)
ffffffffc0204a9c:	84aa                	mv	s1,a0
ffffffffc0204a9e:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204aa0:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204aa4:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204aa6:	03067e63          	bgeu	a2,a6,ffffffffc0204ae2 <printnum+0x60>
ffffffffc0204aaa:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204aac:	00805763          	blez	s0,ffffffffc0204aba <printnum+0x38>
ffffffffc0204ab0:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204ab2:	85ca                	mv	a1,s2
ffffffffc0204ab4:	854e                	mv	a0,s3
ffffffffc0204ab6:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204ab8:	fc65                	bnez	s0,ffffffffc0204ab0 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aba:	1a02                	slli	s4,s4,0x20
ffffffffc0204abc:	00002797          	auipc	a5,0x2
ffffffffc0204ac0:	36c78793          	addi	a5,a5,876 # ffffffffc0206e28 <default_pmm_manager+0x1198>
ffffffffc0204ac4:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ac8:	9a3e                	add	s4,s4,a5
}
ffffffffc0204aca:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204acc:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204ad0:	70a2                	ld	ra,40(sp)
ffffffffc0204ad2:	69a2                	ld	s3,8(sp)
ffffffffc0204ad4:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ad6:	85ca                	mv	a1,s2
ffffffffc0204ad8:	87a6                	mv	a5,s1
}
ffffffffc0204ada:	6942                	ld	s2,16(sp)
ffffffffc0204adc:	64e2                	ld	s1,24(sp)
ffffffffc0204ade:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ae0:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ae2:	03065633          	divu	a2,a2,a6
ffffffffc0204ae6:	8722                	mv	a4,s0
ffffffffc0204ae8:	f9bff0ef          	jal	ra,ffffffffc0204a82 <printnum>
ffffffffc0204aec:	b7f9                	j	ffffffffc0204aba <printnum+0x38>

ffffffffc0204aee <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204aee:	7119                	addi	sp,sp,-128
ffffffffc0204af0:	f4a6                	sd	s1,104(sp)
ffffffffc0204af2:	f0ca                	sd	s2,96(sp)
ffffffffc0204af4:	ecce                	sd	s3,88(sp)
...
ffffffffc0204afe:	f06a                	sd	s10,32(sp)
ffffffffc0204b00:	fc86                	sd	ra,120(sp)
ffffffffc0204b02:	f8a2                	sd	s0,112(sp)
ffffffffc0204b04:	f862                	sd	s8,48(sp)
ffffffffc0204b06:	f466                	sd	s9,40(sp)
ffffffffc0204b08:	ec6e                	sd	s11,24(sp)
ffffffffc0204b0a:	892a                	mv	s2,a0
ffffffffc0204b0c:	84ae                	mv	s1,a1
ffffffffc0204b0e:	8d32                	mv	s10,a2
ffffffffc0204b10:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b12:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc0204b18:	00002a97          	auipc	s5,0x2
ffffffffc0204b1c:	33ca8a93          	addi	s5,s5,828 # ffffffffc0206e54 <default_pmm_manager+0x11c4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b20:	00002b97          	auipc	s7,0x2
ffffffffc0204b24:	510b8b93          	addi	s7,s7,1296 # ffffffffc0207030 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b28:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b2c:	001d0413          	addi	s0,s10,1
ffffffffc0204b30:	01350a63          	beq	a0,s3,ffffffffc0204b44 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b34:	c121                	beqz	a0,ffffffffc0204b74 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b40:	ff351ae3          	bne	a0,s3,ffffffffc0204b34 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b44:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b48:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b4c:	4c81                	li	s9,0
ffffffffc0204b4e:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b50:	5c7d                	li	s8,-1
ffffffffc0204b52:	5dfd                	li	s11,-1
ffffffffc0204b54:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b58:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b5a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b5e:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b62:	00140d13          	addi	s10,s0,1
ffffffffc0204b66:	04b56263          	bltu	a0,a1,ffffffffc0204baa <vprintfmt+0xbc>
ffffffffc0204b6a:	058a                	slli	a1,a1,0x2
ffffffffc0204b6c:	95d6                	add	a1,a1,s5
ffffffffc0204b6e:	4194                	lw	a3,0(a1)
ffffffffc0204b70:	96d6                	add	a3,a3,s5
...
ffffffffc0204b90:	8082                	ret
            padc = '0';
ffffffffc0204b92:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b94:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b98:	846a                	mv	s0,s10
ffffffffc0204b9a:	00140d13          	addi	s10,s0,1
ffffffffc0204b9e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ba2:	0ff5f593          	zext.b	a1,a1
ffffffffc0204ba6:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b6a <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204baa:	85a6                	mv	a1,s1
ffffffffc0204bac:	02500513          	li	a0,37
ffffffffc0204bb0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bb2:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bb6:	8d22                	mv	s10,s0
ffffffffc0204bb8:	f73788e3          	beq	a5,s3,ffffffffc0204b28 <vprintfmt+0x3a>
ffffffffc0204bbc:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bc0:	1d7d                	addi	s10,s10,-1
ffffffffc0204bc2:	ff379de3          	bne	a5,s3,ffffffffc0204bbc <vprintfmt+0xce>
ffffffffc0204bc6:	b78d                	j	ffffffffc0204b28 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bc8:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bcc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bd0:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bd2:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bd6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bda:	02d86463          	bltu	a6,a3,ffffffffc0204c02 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bde:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204be2:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204be6:	0186873b          	addw	a4,a3,s8
ffffffffc0204bea:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bee:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bf0:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bf4:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bf6:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bfa:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bfe:	fed870e3          	bgeu	a6,a3,ffffffffc0204bde <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c02:	f40ddce3          	bgez	s11,ffffffffc0204b5a <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c06:	8de2                	mv	s11,s8
ffffffffc0204c08:	5c7d                	li	s8,-1
ffffffffc0204c0a:	bf81                	j	ffffffffc0204b5a <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c0c:	fffdc693          	not	a3,s11
ffffffffc0204c10:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c12:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c16:	00144603          	lbu	a2,1(s0)
ffffffffc0204c1a:	2d81                	sext.w	s11,s11
ffffffffc0204c1c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c1e:	bf35                	j	ffffffffc0204b5a <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c20:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c24:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c28:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2a:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c2c:	bfd9                	j	ffffffffc0204c02 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c2e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c30:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c34:	01174463          	blt	a4,a7,ffffffffc0204c3c <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c38:	1a088e63          	beqz	a7,ffffffffc0204df4 <vprintfmt+0x306>
...
ffffffffc0204c46:	876e                	mv	a4,s11
ffffffffc0204c48:	85a6                	mv	a1,s1
ffffffffc0204c4a:	854a                	mv	a0,s2
ffffffffc0204c4c:	e37ff0ef          	jal	ra,ffffffffc0204a82 <printnum>
            break;
ffffffffc0204c50:	bde1                	j	ffffffffc0204b28 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c52:	000a2503          	lw	a0,0(s4)
ffffffffc0204c56:	85a6                	mv	a1,s1
ffffffffc0204c58:	0a21                	addi	s4,s4,8
ffffffffc0204c5a:	9902                	jalr	s2
            break;
ffffffffc0204c5c:	b5f1                	j	ffffffffc0204b28 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c5e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c60:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c64:	01174463          	blt	a4,a7,ffffffffc0204c6c <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c68:	18088163          	beqz	a7,ffffffffc0204dea <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c6c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c70:	46a9                	li	a3,10
ffffffffc0204c72:	8a2e                	mv	s4,a1
ffffffffc0204c74:	bfc1                	j	ffffffffc0204c44 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c76:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c7a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c7c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c7e:	bdf1                	j	ffffffffc0204b5a <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c80:	85a6                	mv	a1,s1
ffffffffc0204c82:	02500513          	li	a0,37
ffffffffc0204c86:	9902                	jalr	s2
            break;
ffffffffc0204c88:	b545                	j	ffffffffc0204b28 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c8a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c8e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c90:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c92:	b5e1                	j	ffffffffc0204b5a <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c94:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c96:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c9a:	01174463          	blt	a4,a7,ffffffffc0204ca2 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c9e:	14088163          	beqz	a7,ffffffffc0204de0 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204ca2:	000a3603          	ld	a2,0(s4)
ffffffffc0204ca6:	46a1                	li	a3,8
ffffffffc0204ca8:	8a2e                	mv	s4,a1
ffffffffc0204caa:	bf69                	j	ffffffffc0204c44 <vprintfmt+0x156>
            putch('0', putdat);
...
ffffffffc0204cbe:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cc0:	6782                	ld	a5,0(sp)
ffffffffc0204cc2:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cc4:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cc8:	bfb5                	j	ffffffffc0204c44 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cca:	000a3403          	ld	s0,0(s4)
ffffffffc0204cce:	008a0713          	addi	a4,s4,8
ffffffffc0204cd2:	e03a                	sd	a4,0(sp)
ffffffffc0204cd4:	14040263          	beqz	s0,ffffffffc0204e18 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cd8:	0fb05763          	blez	s11,ffffffffc0204dc6 <vprintfmt+0x2d8>
ffffffffc0204cdc:	02d00693          	li	a3,45
ffffffffc0204ce0:	0cd79163          	bne	a5,a3,ffffffffc0204da2 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce4:	00044783          	lbu	a5,0(s0)
ffffffffc0204ce8:	0007851b          	sext.w	a0,a5
ffffffffc0204cec:	cf85                	beqz	a5,ffffffffc0204d24 <vprintfmt+0x236>
ffffffffc0204cee:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cf2:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cf6:	000c4563          	bltz	s8,ffffffffc0204d00 <vprintfmt+0x212>
ffffffffc0204cfa:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cfc:	036c0263          	beq	s8,s6,ffffffffc0204d20 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d00:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d02:	0e0c8e63          	beqz	s9,ffffffffc0204dfe <vprintfmt+0x310>
ffffffffc0204d06:	3781                	addiw	a5,a5,-32
ffffffffc0204d08:	0ef47b63          	bgeu	s0,a5,ffffffffc0204dfe <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d0c:	03f00513          	li	a0,63
ffffffffc0204d10:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d12:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d16:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d18:	0a05                	addi	s4,s4,1
ffffffffc0204d1a:	0007851b          	sext.w	a0,a5
ffffffffc0204d1e:	ffe1                	bnez	a5,ffffffffc0204cf6 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d20:	01b05963          	blez	s11,ffffffffc0204d32 <vprintfmt+0x244>
...
ffffffffc0204d2c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d2e:	fe0d9be3          	bnez	s11,ffffffffc0204d24 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d32:	6a02                	ld	s4,0(sp)
ffffffffc0204d34:	bbd5                	j	ffffffffc0204b28 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d36:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d38:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d3c:	01174463          	blt	a4,a7,ffffffffc0204d44 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d40:	08088d63          	beqz	a7,ffffffffc0204dda <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d44:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d48:	0a044d63          	bltz	s0,ffffffffc0204e02 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d4c:	8622                	mv	a2,s0
ffffffffc0204d4e:	8a66                	mv	s4,s9
ffffffffc0204d50:	46a9                	li	a3,10
ffffffffc0204d52:	bdcd                	j	ffffffffc0204c44 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d54:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d58:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d5a:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d5c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d60:	8fb5                	xor	a5,a5,a3
ffffffffc0204d62:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d66:	02d74163          	blt	a4,a3,ffffffffc0204d88 <vprintfmt+0x29a>
ffffffffc0204d6a:	00369793          	slli	a5,a3,0x3
ffffffffc0204d6e:	97de                	add	a5,a5,s7
ffffffffc0204d70:	639c                	ld	a5,0(a5)
ffffffffc0204d72:	cb99                	beqz	a5,ffffffffc0204d88 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d74:	86be                	mv	a3,a5
ffffffffc0204d76:	00000617          	auipc	a2,0x0
ffffffffc0204d7a:	1f260613          	addi	a2,a2,498 # ffffffffc0204f68 <etext+0x2e>
ffffffffc0204d7e:	85a6                	mv	a1,s1
ffffffffc0204d80:	854a                	mv	a0,s2
ffffffffc0204d82:	0ce000ef          	jal	ra,ffffffffc0204e50 <printfmt>
ffffffffc0204d86:	b34d                	j	ffffffffc0204b28 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d88:	00002617          	auipc	a2,0x2
ffffffffc0204d8c:	0c060613          	addi	a2,a2,192 # ffffffffc0206e48 <default_pmm_manager+0x11b8>
ffffffffc0204d90:	85a6                	mv	a1,s1
ffffffffc0204d92:	854a                	mv	a0,s2
ffffffffc0204d94:	0bc000ef          	jal	ra,ffffffffc0204e50 <printfmt>
ffffffffc0204d98:	bb41                	j	ffffffffc0204b28 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d9a:	00002417          	auipc	s0,0x2
ffffffffc0204d9e:	0a640413          	addi	s0,s0,166 # ffffffffc0206e40 <default_pmm_manager+0x11b0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da2:	85e2                	mv	a1,s8
ffffffffc0204da4:	8522                	mv	a0,s0
ffffffffc0204da6:	e43e                	sd	a5,8(sp)
ffffffffc0204da8:	0e2000ef          	jal	ra,ffffffffc0204e8a <strnlen>
ffffffffc0204dac:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204db0:	01b05b63          	blez	s11,ffffffffc0204dc6 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204db4:	67a2                	ld	a5,8(sp)
ffffffffc0204db6:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dba:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dbc:	85a6                	mv	a1,s1
ffffffffc0204dbe:	8552                	mv	a0,s4
ffffffffc0204dc0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dc2:	fe0d9ce3          	bnez	s11,ffffffffc0204dba <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dc6:	00044783          	lbu	a5,0(s0)
ffffffffc0204dca:	00140a13          	addi	s4,s0,1
ffffffffc0204dce:	0007851b          	sext.w	a0,a5
ffffffffc0204dd2:	d3a5                	beqz	a5,ffffffffc0204d32 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dd4:	05e00413          	li	s0,94
ffffffffc0204dd8:	bf39                	j	ffffffffc0204cf6 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dda:	000a2403          	lw	s0,0(s4)
ffffffffc0204dde:	b7ad                	j	ffffffffc0204d48 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204de0:	000a6603          	lwu	a2,0(s4)
ffffffffc0204de4:	46a1                	li	a3,8
ffffffffc0204de6:	8a2e                	mv	s4,a1
ffffffffc0204de8:	bdb1                	j	ffffffffc0204c44 <vprintfmt+0x156>
ffffffffc0204dea:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dee:	46a9                	li	a3,10
ffffffffc0204df0:	8a2e                	mv	s4,a1
ffffffffc0204df2:	bd89                	j	ffffffffc0204c44 <vprintfmt+0x156>
ffffffffc0204df4:	000a6603          	lwu	a2,0(s4)
ffffffffc0204df8:	46c1                	li	a3,16
ffffffffc0204dfa:	8a2e                	mv	s4,a1
ffffffffc0204dfc:	b5a1                	j	ffffffffc0204c44 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204dfe:	9902                	jalr	s2
ffffffffc0204e00:	bf09                	j	ffffffffc0204d12 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204e02:	85a6                	mv	a1,s1
ffffffffc0204e04:	02d00513          	li	a0,45
ffffffffc0204e08:	e03e                	sd	a5,0(sp)
ffffffffc0204e0a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e0c:	6782                	ld	a5,0(sp)
ffffffffc0204e0e:	8a66                	mv	s4,s9
ffffffffc0204e10:	40800633          	neg	a2,s0
ffffffffc0204e14:	46a9                	li	a3,10
ffffffffc0204e16:	b53d                	j	ffffffffc0204c44 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e18:	03b05163          	blez	s11,ffffffffc0204e3a <vprintfmt+0x34c>
ffffffffc0204e1c:	02d00693          	li	a3,45
ffffffffc0204e20:	f6d79de3          	bne	a5,a3,ffffffffc0204d9a <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e24:	00002417          	auipc	s0,0x2
ffffffffc0204e28:	01c40413          	addi	s0,s0,28 # ffffffffc0206e40 <default_pmm_manager+0x11b0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e2c:	02800793          	li	a5,40
ffffffffc0204e30:	02800513          	li	a0,40
ffffffffc0204e34:	00140a13          	addi	s4,s0,1
ffffffffc0204e38:	bd6d                	j	ffffffffc0204cf2 <vprintfmt+0x204>
ffffffffc0204e3a:	00002a17          	auipc	s4,0x2
ffffffffc0204e3e:	007a0a13          	addi	s4,s4,7 # ffffffffc0206e41 <default_pmm_manager+0x11b1>
ffffffffc0204e42:	02800513          	li	a0,40
ffffffffc0204e46:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e4a:	05e00413          	li	s0,94
ffffffffc0204e4e:	b565                	j	ffffffffc0204cf6 <vprintfmt+0x208>

ffffffffc0204e50 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e50:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e52:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e56:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e58:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e5a:	ec06                	sd	ra,24(sp)
ffffffffc0204e5c:	f83a                	sd	a4,48(sp)
ffffffffc0204e5e:	fc3e                	sd	a5,56(sp)
ffffffffc0204e60:	e0c2                	sd	a6,64(sp)
ffffffffc0204e62:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e64:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e66:	c89ff0ef          	jal	ra,ffffffffc0204aee <vprintfmt>
}
ffffffffc0204e6a:	60e2                	ld	ra,24(sp)
ffffffffc0204e6c:	6161                	addi	sp,sp,80
ffffffffc0204e6e:	8082                	ret

ffffffffc0204e70 <strlen>:
...
strlen(const char *s) {
ffffffffc0204e74:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e76:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e78:	cb81                	beqz	a5,ffffffffc0204e88 <strlen+0x18>
        cnt ++;
ffffffffc0204e7a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e7c:	00a707b3          	add	a5,a4,a0
ffffffffc0204e80:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e84:	fbfd                	bnez	a5,ffffffffc0204e7a <strlen+0xa>
...
ffffffffc0204e8a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e8c:	e589                	bnez	a1,ffffffffc0204e96 <strnlen+0xc>
ffffffffc0204e8e:	a811                	j	ffffffffc0204ea2 <strnlen+0x18>
        cnt ++;
ffffffffc0204e90:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e92:	00f58863          	beq	a1,a5,ffffffffc0204ea2 <strnlen+0x18>
ffffffffc0204e96:	00f50733          	add	a4,a0,a5
ffffffffc0204e9a:	00074703          	lbu	a4,0(a4)
ffffffffc0204e9e:	fb6d                	bnez	a4,ffffffffc0204e90 <strnlen+0x6>
ffffffffc0204ea0:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204ea2:	852e                	mv	a0,a1
ffffffffc0204ea4:	8082                	ret

ffffffffc0204ea6 <strcpy>:
char *
...
ffffffffc0204eb0:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204eb4:	fb75                	bnez	a4,ffffffffc0204ea8 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204ebc:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ec0:	cb89                	beqz	a5,ffffffffc0204ed2 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ec2:	0505                	addi	a0,a0,1
ffffffffc0204ec4:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ec6:	fee789e3          	beq	a5,a4,ffffffffc0204eb8 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eca:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ece:	9d19                	subw	a0,a0,a4
ffffffffc0204ed0:	8082                	ret
ffffffffc0204ed2:	4501                	li	a0,0
ffffffffc0204ed4:	bfed                	j	ffffffffc0204ece <strcmp+0x16>
...
ffffffffc0204ef4:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204ef8:	fec79de3          	bne	a5,a2,ffffffffc0204ef2 <memset+0x6>
    }
    return s;
...
ffffffffc0204f08:	0585                	addi	a1,a1,1
ffffffffc0204f0a:	0785                	addi	a5,a5,1
ffffffffc0204f0c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f10:	fec59ae3          	bne	a1,a2,ffffffffc0204f04 <memcpy+0x6>
    }
    return dst;
...
ffffffffc0204f1c:	00c58d63          	beq	a1,a2,ffffffffc0204f36 <memcmp+0x20>
        if (*s1 != *s2) {
