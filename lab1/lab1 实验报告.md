...
## make评测结果
使用`make grade`进行评测，输出如下：
```
gugu@LAPTOP-DFJ5NH5N:~/riscv/riscv64-ucore-labcodes/lab1$ make grade
gmake[1]: Entering directory '/home/gugu/riscv/riscv64-ucore-labcodes/lab1' + cc kern/init/entry.S + cc kern/init/init.c + cc kern/libs/stdio.c + cc kern/debug/kdebug.c + cc kern/debug/kmonitor.c + cc kern/debug/panic.c + cc kern/driver/clock.c + cc kern/driver/console.c + cc kern/driver/intr.c + cc kern/trap/trap.c + cc kern/trap/trapentry.S + cc kern/mm/pmm.c + cc libs/printfmt.c + cc libs/readline.c + cc libs/sbi.c + cc libs/string.c + ld bin/kernel riscv64-unknown-elf-objcopy bin/kernel --strip-all -O binary bin/ucore.img gmake[1]: Leaving directory '/home/gugu/riscv/riscv64-ucore-labcodes/lab1'
try to run qemu
qemu pid=10798
  -100 ticks:                                OK
Total Score: 100/100
